    ...
    function do_upload()
    {
        ...
        {           
            ...
            if ($this->upload->do_upload('userfile')) {
                ...
                $data['error'] = "<div class='alert alert-success' role='alert'>Files successfully uploaded!</div>";
            } else {
                $data['error'] = "<div class='alert alert-warning' role='alert'>" . $this->upload->display_errors() . "</div>";
            }
        }
        if ( ! $this->upload->do_upload('userfile')) {
            $this->load->view('template/header');
